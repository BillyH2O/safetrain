...
export default function ChatList({chats, chatId}: Props) {
  return (
    <div className='flex flex-col gap-5 bg-black items-center max-w-96 p-6 h-full overflow-y-scroll overflow-x-hidden'> 
        ...
        {chats.map((chat) => (
        <Link key={chat.id} href={chat.fileKey} className={cn('flex justify-between items-center gap-4 text-white w-72 p-4', {
